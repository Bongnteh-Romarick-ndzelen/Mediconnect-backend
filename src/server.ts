...
import patientSettingsRoutes from './routes/patientSettingsRoutes.js';
import providerRoutes from './routes/providerRoutes.js';
import providerSettingsRoutes from './routes/providerSettingsRoutes.js';
...
app.use('/api/patients', authenticate, patientSettingsRoutes);
app.use('/api/providers', providerRoutes);
app.use('/api/providers', providerSettingsRoutes);
